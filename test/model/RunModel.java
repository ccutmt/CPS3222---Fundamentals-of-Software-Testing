...
public class RunModel implements FsmModel, Runnable {
	...
	public boolean proceedToBetSuccessGuard() {
		...
		if ((prob > 0.5 && getState().equals(States.BettingPage))
				&& ((this.acount_type.compareTo("premium") == 0) || (probInvalidBetAmount > (5 / 6)))) {
			return true;
		} else
			return false;
	}

	public void proceedToBetSuccessful() {
	...
	public boolean logoutGuard() {
		...
		return (ran <= 0.5 && getState().equals(States.BettingPage));
	}
